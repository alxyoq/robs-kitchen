...
export default function FloatingPurchaseButton() {
  ...
  return (
    <a
      ...
      aria-label="Buy this website for $499 plus $20 per month through secure Stripe checkout"
    >
      ...
      <span className="text-left leading-tight">
        ...
        <span className="mt-0.5 block text-[11px] font-semibold text-white/75 sm:text-xs">
          $499 + $20/month
        </span>
      </span>
    </a>
